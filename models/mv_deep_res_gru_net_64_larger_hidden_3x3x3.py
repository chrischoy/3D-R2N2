...
class RecNet(Net):
    def network_definition(self):
        ...
        n_fc_filters = [1024]
        n_deconvfilter = [192, 192, 128, 92, 92, 2]
        ...
        conv8c  = Conv3DLayer(unpool8, (n_deconvfilter[2], 1, 1, 1))
        res8    = AddLayer(conv8c, rect8)
        ...
        unpool10 = Unpool3DLayer(res9)
        conv10a = Conv3DLayer(unpool10, (n_deconvfilter[4], 3, 3, 3))
        rect10a = LeakyReLU(conv10a)
        conv10b = Conv3DLayer(rect10a, (n_deconvfilter[4], 3, 3, 3))
        rect10  = LeakyReLU(conv10b)

        conv10c = Conv3DLayer(unpool10, (n_deconvfilter[4], 1, 1, 1))
        ...
        params = \
            conv1a.params + conv1b.params + conv2a.params + conv2b.params + \
            conv3a.params + conv3b.params + conv4a.params + conv4b.params + \
            conv5a.params + conv5b.params + conv6a.params + conv6b.params + \
            fc7.params + \
            t_x_s_update.params + t_x_s_reset.params + t_x_rs.params + \
            conv7a.params + conv7b.params + \
            conv8a.params + conv8b.params + conv8c.params + \
            conv9a.params + conv9b.params + conv9c.params + \
            conv10a.params + conv10b.params + conv10c.params + \
            conv11.params
