...
class RecNet(Net):
    def network_definition(self):
        ...
        s_vec_shape = (self.batch_size, n_gru_vox ** 3 * n_deconvfilter[0])

        # Dummy 3D grid hidden representations
        prev_s = InputLayer(s_shape)

        t_x_s_update = FCConv3DLayer(prev_s, fc7, (n_deconvfilter[0], n_deconvfilter[0], 1, 1, 1))
        t_x_s_reset  = FCConv3DLayer(prev_s, fc7, (n_deconvfilter[0], n_deconvfilter[0], 1, 1, 1))
        ...
        t_x_rs = FCConv3DLayer(rs, fc7, (n_deconvfilter[0], n_deconvfilter[0], 1, 1, 1))
        ...
        def recurrence(x_curr, prev_s_tensor, prev_in_gate_tensor):
            ...
            t_x_s_update_ = FCConv3DLayer(prev_s_, rect7_, (n_deconvfilter[0], n_deconvfilter[0], 1, 1, 1), params=t_x_s_update.params)
            t_x_s_reset_  = FCConv3DLayer(prev_s_, rect7_, (n_deconvfilter[0], n_deconvfilter[0], 1, 1, 1), params=t_x_s_reset.params)
            ...
            t_x_rs_ = FCConv3DLayer(rs_, rect7_, (n_deconvfilter[0], n_deconvfilter[0], 1, 1, 1), params=t_x_rs.params)
